...
const STEPS = [
  ...
  },
  {
    ...
    enter(s, ctx) {
      ...
      ctx.register(animateAlong(p, [[540, 65], [580, 65]], { duration: 700 }));
      ctx.register(p.animate([{ opacity: 1 }, { opacity: 0 }], { duration: 200, delay: 700, fill: 'forwards', easing: 'ease-in' }));
    },
  },
  {
    id: 'surge',
    ...
    enter(s, ctx) {
      ...
      // kubectl-style scale PATCH reaches ApiServer, then the create flows down to the node.
  ...
  },
  {
    ...
    enter(s, ctx) {
      ...
      ctx.register(s.refs.pod3.animate([{ opacity: 1 }, { opacity: 0.4 }], { duration: 700, delay: 1900, fill: 'both', easing: 'ease-in' }));
    },
  },
  {
    id: 'second-cycle',
    ...
    enter(s, ctx) {
      ...
      // Scale PATCH reaches ApiServer, then the create flows down to slot web-2.
      const pTop = packet({ x: 540, y: 65, cat: 'control' });
      s.refs.packetLayer.appendChild(pTop);
      ctx.register(animateAlong(pTop, [[540, 65], [580, 65]], { duration: 700 }));
      ctx.register(pTop.animate([{ opacity: 1 }, { opacity: 0 }], { duration: 200, delay: 700, fill: 'forwards', easing: 'ease-in' }));
  ...
  },
  {
    ...
    enter(s, ctx) {
      ...
      connectorPacket(s, ctx, { delay: 800, dur: 1100 });
      ctx.register(s.refs.pod3.animate([{ opacity: 0.4 }, { opacity: 1 }], { duration: 700, delay: 1900, fill: 'both', easing: 'ease-out' }));
      pulsePod(s.refs.pod3, ctx, 1900);
    },
  },
  {
