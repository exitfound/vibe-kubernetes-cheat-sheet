...
const CB_W = 140;
const WR_X = 250, WR_CX = 320;
const ED_X = 410, ED_CX = 480;
const LG_X = 570, LG_CX = 640;

const DISK_X = 300, DISK_Y = 400, DISK_W = 360, DISK_H = 120; // centered on 480
const DISK_TOP = DISK_Y;                               // 400
const THRESH_Y = 432;

const PB_X = 750, PB_Y = 85, PC_Y = 177, OP_W = 200, OP_H = 72; // top-aligned with the focus Pod
...
const STEPS = [
  ...
  },
  {
    ...
    enter(s, ctx) {
      ...
      ctx.register(s.refs.focusPod.animate([{ opacity: 1 }, { opacity: 0.25 }], { duration: 600, delay: arrival + 150, fill: 'forwards', easing: 'ease-in' }));
    },
  },
  {
    id: 'diskPressure',
  ...
  },
  {
    ...
    enter(s, ctx) {
      ...
      ctx.register(s.refs.otherB.animate([{ opacity: 1 }, { opacity: 0.25 }], { duration: 600, delay: BEAT.afterPulse, fill: 'forwards', easing: 'ease-in' }));
      pulsePod(s.refs.otherCG, ctx, 1000);
      ctx.register(s.refs.otherC.animate([{ opacity: 1 }, { opacity: 0.45 }], { duration: 600, delay: 1000 + BEAT.afterPulse, fill: 'forwards', easing: 'ease-in' }));
    },
  },
  {
    id: 'distinct',
